...
* **Method 1: Explicit Snowfall (Standard Models)**  
  ...
  * Directly requests the snowfall\_sum variable from the model physics.  
...
Open snow\_tracker.py and modify the configuration block to target different SNOTEL sites or regions:

STATE \= 'OR'  
AREA \= 'Mt. Hood Area' \# Name for the chart title  
LAT \= 45.37  \# Latitude for forecast  
LON \= \-121.70 \# Longitude for forecast  
SITE\_IDS \= \[123, 456\] \# SNOTEL Site IDs found on USDA map

### **Running the Tool**

Run the script directly:

python snow\_tracker.py

The script will output an HTML file to your Documents folder (or configured OUTPUT\_DIR):  
\~/Documents/Snow/snotel\_forecast\_YYYYMMDD.html
